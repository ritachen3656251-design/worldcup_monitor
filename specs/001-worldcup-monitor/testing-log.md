...
记录过滤、聚类、生成等环节中发现的质量问题，供后续 prompt 调优参考。

### 相关性过滤 Badcase

| ID | 来源 | 评分 | 标题 | 期望分 | 问题分析 |
|----|------|------|------|--------|----------|
| 27 | 懂球帝 | 4 | 世界杯史话37：上帝之手与连过五人 | >=7 | 世界杯历史专栏文章，有阅读价值。标题未含"2026"导致评分偏低，prompt 评分标准过度依赖"2026"关键词 |
| 36 | 懂球帝 | 4 | 五大洲各自最贵阵容：欧洲13.9亿欧第一，南美8.97亿，亚洲2.51亿 | >=7 | 世界杯参赛队阵容分析，高度相关。标题未含"世界杯"三字但上下文明显是世界杯内容，prompt 无法识别隐含语境 |

**共性原因**: prompt 评分标准中 9-10 分要求"直接讨论2026世界杯"，7-8 分要求"与世界杯高度相关"，但判断过度依赖标题中是否出现"2026"或"世界杯"字面关键词，对隐含语境（如"五大洲阵容"本身就是世界杯语境）识别不足。

**待决策**: 是否修改 prompt 评分标准，放宽对关键词的依赖，增加语境理解要求。
